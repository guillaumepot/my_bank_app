...
### Account Functions ###
def create_account(name: str, type:str, amount: float = 0.0):
    """
    Creates a new account object.

    Parameters:
        name (str): The name of the account.
        account_type (str): The type of the account (checking or savings).
        amount (float): The initial amount of the account.

    Returns:
        Account: The newly created account object.
    """
    return Account(name, type, amount)